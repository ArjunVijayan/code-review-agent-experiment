...
- `pr-quality-assistant/skills/pr-code-merger/SKILL.md` (added)
- `pr-quality-assistant/skills/pr-code-merger/references/merge-policy.json` (added)
- `pr-quality-assistant/skills/pr-code-merger/references/merger-guidance.md` (added)
- `pr-quality-assistant/skills/pr-code-merger/scripts/decide-merge.py` (added)
- `pr-quality-assistant/skills/pr-code-merger/scripts/render-blast-radius.py` (added)
...
- `pr-quality-assistant/skills/pr-code-review/scripts/archive-review-run.py` (added)
...
- `pr-quality-assistant/skills/pr-code-review/scripts/ensure-review-assessment.py` (added)
...
- `pr-quality-assistant/skills/pr-code-review/scripts/provider_adapters.py` (added)
- `pr-quality-assistant/skills/pr-code-review/scripts/render-review-report.py` (added)
- `pr-quality-assistant/skills/pr-code-review/scripts/resolve_change_request.py` (added)
...
- `fc349b9aada1` updated code review flow (Arjun V, 2026-08-26T14:05:51+05:30)
- `6256c6ddd0e5` added changes to enrich the html report (Arjun V, 2026-08-26T13:47:22+05:30)
- `2c79ceaeb975` updated version (Arjun V, 2026-08-26T13:19:16+05:30)
- `4ed09af327c3` insights state made empty (Arjun V, 2026-08-26T13:16:09+05:30)
- `d18c909ca116` added changes to accepotance criteria ngeneration (Arjun V, 2026-08-26T13:07:57+05:30)
- `1469ea172180` corrected historical pr collector (Arjun V, 2026-08-26T13:00:54+05:30)
- `54ee7bf7ae60` Modularize historical VCS provider adapters (Arjun V, 2026-08-26T11:55:33+05:30)
- `29db19539dac` Fetch historical PR feedback from detected provider (Arjun V, 2026-08-26T11:51:55+05:30)
- `9432243882cd` Fix historical discovery default paths (Arjun V, 2026-08-26T11:34:15+05:30)
- `21f6a724935c` added guardrails to code review skill (Arjun V, 2026-08-26T11:26:37+05:30)
- `4eed32a2409f` Accept underscore change URL option (Arjun V, 2026-08-26T02:28:47+05:30)
- `d6130dcd351b` Resolve GitHub PR URLs automatically (Arjun V, 2026-08-26T02:27:44+05:30)
- `f90bd92081a1` Accept change-url review input (Arjun V, 2026-08-26T02:24:20+05:30)
- `0a8e03809d79` Define PR code merger inputs (Arjun V, 2026-08-26T02:21:26+05:30)
- `f2045f98b7cb` Archive review artifacts for traceability (Arjun V, 2026-08-26T02:19:11+05:30)
- `01ad78af10af` Support PR and MR review inputs (Arjun V, 2026-08-26T02:16:02+05:30)
- `9d19b63fe5cb` Always generate unavailable review report (Arjun V, 2026-08-26T02:09:57+05:30)
- `c1ffa8c5a303` Refine evidence-driven review reporting (Arjun V, 2026-08-26T01:59:32+05:30)
- `42799206fce9` Add portable PR code merger skill (Arjun V, 2026-08-26T01:50:50+05:30)
- `4000d84c8f82` added final report generation capability (Arjun V, 2026-08-26T01:41:30+05:30)
...
- `.venv/lib/python3.14/site-packages/mlx/include/metal_cpp/README.md` (scope `/venv/lib/python314/site-packages/mlx/include/metal_cpp`)
...
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-merger/SKILL.md b/pr-quality-assistant/skills/pr-code-merger/SKILL.md
new file mode 100644
index 0000000..aae19ec
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-merger/SKILL.md
@@ -0,0 +1,67 @@
+---
+name: pr-code-merger
...
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-merger/references/merge-policy.json b/pr-quality-assistant/skills/pr-code-merger/references/merge-policy.json
new file mode 100644
index 0000000..35f0b2d
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-merger/references/merge-policy.json
@@ -0,0 +1,24 @@
+{
+  "low": {
+    "auto_merge": true,
...
+    "require_human": true
+  },
+  "require_all_review_gates_pass": true,
+  "blocking_severities": [
+    "BLOCKER",
+    "CRITICAL",
+    "MAJOR"
...
+}
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-merger/references/merger-guidance.md b/pr-quality-assistant/skills/pr-code-merger/references/merger-guidance.md
new file mode 100644
index 0000000..02d9fa2
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-merger/references/merger-guidance.md
@@ -0,0 +1,22 @@
+# Merger Guidance
+
...
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-merger/scripts/decide-merge.py b/pr-quality-assistant/skills/pr-code-merger/scripts/decide-merge.py
new file mode 100644
index 0000000..c826ca5
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-merger/scripts/decide-merge.py
@@ -0,0 +1,76 @@
+#!/usr/bin/env python3
...
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-merger/scripts/render-blast-radius.py b/pr-quality-assistant/skills/pr-code-merger/scripts/render-blast-radius.py
new file mode 100644
index 0000000..554ebe3
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-merger/scripts/render-blast-radius.py
@@ -0,0 +1,43 @@
+#!/usr/bin/env python3
...
+    raise SystemExit(main())
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-review/scripts/archive-review-run.py b/pr-quality-assistant/skills/pr-code-review/scripts/archive-review-run.py
new file mode 100644
index 0000000..5d8cee3
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-review/scripts/archive-review-run.py
@@ -0,0 +1,105 @@
+#!/usr/bin/env python3
...
+    raise SystemExit(main())
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-review/scripts/ensure-review-assessment.py b/pr-quality-assistant/skills/pr-code-review/scripts/ensure-review-assessment.py
new file mode 100644
index 0000000..b0fc7f5
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-review/scripts/ensure-review-assessment.py
@@ -0,0 +1,58 @@
+#!/usr/bin/env python3
...
+        "change_summary": assessment.get("change_summary", []),
...
+    raise SystemExit(main())
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-review/scripts/provider_adapters.py b/pr-quality-assistant/skills/pr-code-review/scripts/provider_adapters.py
new file mode 100644
index 0000000..d35b350
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-review/scripts/provider_adapters.py
@@ -0,0 +1,251 @@
+#!/usr/bin/env python3
...
+    raise SystemExit(main())
\ No newline at end of file
diff --git a/pr-quality-assistant/skills/pr-code-review/scripts/resolve_change_request.py b/pr-quality-assistant/skills/pr-code-review/scripts/resolve_change_request.py
new file mode 100644
index 0000000..1c2c378
--- /dev/null
+++ b/pr-quality-assistant/skills/pr-code-review/scripts/resolve_change_request.py
@@ -0,0 +1,45 @@
+#!/usr/bin/env python3
...
++        if not reference:
++            return "Not supplied"
++        href = reference if reference.startswith(("https://", "http://")) else quote(reference, safe="/._-#")
++        return f'<a href="{html.escape(href, quote=True)}">{html.escape(reference)}</a>'
++
++    issues = "".join(
++        f"<tr><td>{html.escape(item.get('id', item.get('fingerprint', '')))}</td><td>{html.escape(str(item.get('severity', 'INFO')))}</td><td>{html.escape(item.get('issue', ''))}</td><td>{html.escape(str(item.get('evidence', '')))}</td><td>{reference_cell(item)}</td></tr>"
